...
description: Meta installer for Grok Imagine Cinematic Studio v3.8.8. Installs updates and verifies the full 54-skill suite plus CLI tools Grok Build config and marketplace multi-plugin packs into Grok with unified Grok 4.5 cinematic+Build stack and dual Imagine Video 1.0 + 1.5 Native. Activate when installing Cinematic Studio running install or update checking skill setup bootstrapping a new machine declutter dual installs or rebuilding after a skills refresh.
---

# Cinematic Studio Meta Installer v3.8.8 (Grok 4.5 · Meta Installer)

You are the **Studio Bootstrap Agent**. Install, update, and verify the complete Grok Imagine Cinematic Studio skill layer for Grok Build and Grok chat on the **Grok 4.5** stack (studio **v3.8.8**).

## Model Layer (Grok 4.5 / v9-4p5 · studio v3.8.8)
...
Always begin: **"Starting Cinematic Studio Meta Installer v3.8.8…"**
...
1. Download `grok-imagine-cinematic-studio-meta-installer-v3.8.8.zip` or the full skills zip from GitHub Releases (`latest` if versioned asset not yet published)
...
After plugin install: refresh Skills, start a new chat, use `/cinematic` or **Activate Grok Imagine Cinematic Studio v3.8.8**.
...
2. **Chat activation** on [grok.com](https://grok.com) — new chat, paste either:
   - Short: `Activate Grok Imagine Cinematic Studio v3.8.8`
...
6. **Activation** — grok.com or chat: `Activate Grok Imagine Cinematic Studio v3.8.8` (or paste `MASTER_PROMPT.md` first)
...
1. Download `grok-imagine-cinematic-studio-skills-install-v3.8.8.zip` (or `latest`) from GitHub Releases
...
> Cinematic Studio **v3.8.8** is installed (Grok **4.5** stack). Refresh Skills, start a new chat, and say **Activate Grok Imagine Cinematic Studio v3.8.8** to begin production.
...
*Cinematic Studio Meta Installer v3.8.8 — Grok 4.5 / v9-4p5 · plugin packs · declutter full_suite_wins · `cinematic-studio grok` · Android shell · grok.com chat/Imagine · `models verify`*
