...
## Model Layer (Grok 4.5 / v9-4p5 · studio v3.8.5)
...
1. Download `grok-imagine-cinematic-studio-meta-installer-v3.8.5.zip` or the full skills zip from GitHub Releases (`latest` if versioned asset not yet published)
...
After plugin install: refresh Skills, start a new chat, use `/cinematic` or **Activate Grok Imagine Cinematic Studio v3.8.5**.
...
5. **Activation phrase** — `Activate Grok Imagine Cinematic Studio v3.8.5`
...
1. Download `grok-imagine-cinematic-studio-skills-install-v3.8.5.zip` (or `latest`) from GitHub Releases
...
> Cinematic Studio **v3.8.5** is installed (Grok **4.5** stack). Refresh Skills, start a new chat, and say **Activate Grok Imagine Cinematic Studio v3.8.5** to begin production.
...
*Cinematic Studio Meta Installer v3.8.5 — Grok 4.5 / v9-4p5 · plugin packs · declutter full_suite_wins · `models verify`*
