...
**Release asset:** `grok-imagine-cinematic-studio-skills-install-v3.7.1.zip` (or `latest` release)
...
Always begin: **"Starting Cinematic Studio Meta Installer v3.7.1…"**
...
| **Also installs** | `~/Grok-Cinematic-Projects/` — references, `tools/`, `config/`, installer scripts | Skills + **slash commands** from `commands/` |
...
1. Download `grok-imagine-cinematic-studio-meta-installer-v3.7.1.zip` or the full skills zip from GitHub Releases (`latest` if versioned asset not yet published)
...
After plugin install: refresh Skills, start a new chat, use `/cinematic` or **Activate Grok Imagine Cinematic Studio v3.7.1**.
...
5. **Activation phrase** — `Activate Grok Imagine Cinematic Studio v3.7.1`
...
1. Download `grok-imagine-cinematic-studio-skills-install-v3.7.1.zip` (or `latest`) from GitHub Releases
