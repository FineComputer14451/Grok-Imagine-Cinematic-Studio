# Cinematic Studio Meta Installer — Paths Reference v3.8.3 (Grok 4.5 · plugin suite + packs)
...
unzip grok-imagine-cinematic-studio-meta-installer-v3.8.3.zip && ./bootstrap.sh
```
...
| Asset | Notes |
|-------|--------|
| Meta-installer zip | `grok-imagine-cinematic-studio-meta-installer-v3.8.3.zip` — skill + scripts; run `./bootstrap.sh` |
| Full skills zip (latest) | `.../releases/latest/download/grok-imagine-cinematic-studio-skills-install-v3.8.3.zip` |
| Full skills zip (versioned) | `.../releases/download/v3.8.3/grok-imagine-cinematic-studio-skills-install-v3.8.3.zip` |
