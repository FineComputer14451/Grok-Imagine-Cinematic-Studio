...
**Grok Chat modes — Auto / Fast / Expert / Heavy / Build (Grok 4.6 map)**

Chat picker on https://grok.com is **modes**, not API slugs.

**Quick map** (verified 2026-09-06)
• Everyday → **Auto** (router)
• Speed → **Fast**
• Hard reasoning → **Expert** (flagship Chat on the **Grok 4.6** generation)
