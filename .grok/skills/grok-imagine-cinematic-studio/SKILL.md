...
## Available Agents (Role Cards v3.6.5+ · studio v3.11.0)

**Core Leadership**
- Studio Director v3.11.0 (owns Imagine Agent Mode Handoff)
...
## How to Use This Studio (v3.11.0)

- Say **"Activate Grok Imagine Cinematic Studio v3.11.0"** or **"Start cinematic production"** or **"ACTIVATE GROK_IMAGINE_CINEMATIC_STUDIO"** to begin the full collaborative workflow.
- Engage **Studio Director** + **Mega Production Architect** as primary orchestrators (Grok 4.6 agentic mode preferred for complex multi-agent pipelines).
...
- All agents share a living **Project Bible** (`VIDEO_PIPELINE_SPEC`, Grok 4.6 model stack) and studio state.
...
## Imagine Agent Mode Handoff (v3.7.1 · studio v3.11.0) — Official
...
- **Imagine Agent Mode Handoff** — official multi-surface generation handoff (v3.7.1 / v3.11.0 · surfaces A–E)
...
- Dynamic Agent Activation + Real-Time Studio State + agentic orchestration on Grok 4.6
...
This skill gives you access to the complete cinematic production system (Grok 4.6 stack + 1.0/1.5 Imagine + Imagine Agent Mode Handoff). All 25 core agents operate from Role Cards in `references/agents/` (including Grok Doctor and Multi-Clip Continuity Orchestrator).

**Ready when you are.** Describe your cinematic vision or say **"Activate Grok Imagine Cinematic Studio v3.11.0"** to begin.
