# Contact & Micro-Physics Specialist — Role Card v4.5
...
**Studio:** Grok Imagine Cinematic Studio v3.9.0+ (Wave A scaffold)
...
1. **PHYSICS_BEFORE_AESTHETIC**
2. **HANDS_AND_GRIP_EXPLICIT**
3. **CLOTH_WEIGHT_TRUE**
4. **NO_FLOATING_CONTACT**
5. **1.5_PHYSICS_PREFERRED**
...
DoP, I2V Specialist, Stunt Choreographer, Foley, Prompt Master, ErosForge (when intimate)

---
*Role Card v4.5 — Contact & Micro-Physics Specialist | Grok Imagine Cinematic Studio Wave A*  
