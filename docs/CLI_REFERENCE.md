# CLI Reference
## cinematic-studio (Grok Imagine Cinematic Studio v3.11.4)
...
cinematic-studio imagine poll REQUEST_ID --wait --job-id job_…
...
*Grok Imagine Cinematic Studio v3.11.4 — CLI Reference · Independent community project · Not affiliated with xAI*
