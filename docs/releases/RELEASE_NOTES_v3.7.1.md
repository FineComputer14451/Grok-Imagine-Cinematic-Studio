...
- `MASTER_PROMPT.md` — Activation prompt (unified Grok 4.5 stack + 1.5 + v3.6.7 wizard pointers)
...
- `docs/guides/Quick_Start_Guide.md` — Model stack §0, wizard, activation **v3.6.7**
- `docs/releases/RELEASE_NOTES_v3.7.1.md` — This file (through v3.6.7 patch)
- `docs/guides/UPGRADE_GUIDE.md` — v3.5 → v3.6 migration (unified 4.5 stack + wizard + pin hygiene)
- `docs/guides/installation_guide.md` — Meta installer + plugin install paths
...
Copy MASTER_PROMPT.md into a new chat
...
See `docs/guides/Quick_Start_Guide.md` for full onboarding (model stack, wizard, plugin marketplace).
