...
**Version:** 3.11.4 (September 2026) — official Image 2.0 `images[]` edits · served `model` · Imagine Image Quality retirement · SpaceXAI AUP gates · Grok 4.6 stack lock · Grok Build ≥ 1.0.5 · Imagine Image 2.0 + Video 1.0/1.5 · v4.5 Dual-Model Wave  
...
## ✨ Current State (September 2026 — v3.11.4)

- **25 Role-Card core agents** with complete Role Cards in `references/agents/` (v3.6.5 labels; studio release **v3.11.4**)
...
### Method 3: Full Activation Prompt (Classic — Updated for v3.11.4)
...
3. Type: `Activate Grok Imagine Cinematic Studio v3.11.4`
...
**You are now running the full Grok Imagine Cinematic Studio v3.11.4 "Odyssey Native". **

Type `Activate Grok Imagine Cinematic Studio v3.11.4` to begin.
